...
namespace System.Windows.Forms
{
    public class TaskDialog
    {
        ...
        /// </summary>
        public event EventHandler<TaskDialogTimerEventArgs> TimerTicked;
        ...
        */
        ...
        {
            return (config.dwFlags & (int)flag) == (int)flag;
        }
        ...
        public TaskDialogCommonButtons CommonButtons
        {
            ...
            {
                EnsureNotShowing();
                config.dwCommonButtons = (int)(TASKDIALOG_COMMON_BUTTON_FLAGS)value;
            }
        }
    ...
    public sealed class TaskDialogButtonEventArgs : TaskDialogEventArgs
    {
    ...
    public sealed class TaskDialogExpandoEventArgs : TaskDialogEventArgs
    {
    ...
    public sealed class TaskDialogHyperlinkEventArgs : TaskDialogEventArgs
    {
    ...
    public sealed class TaskDialogTimerEventArgs : TaskDialogEventArgs
    {
    ...
    public sealed class TaskDialogVerificationEventArgs : TaskDialogEventArgs
    {
