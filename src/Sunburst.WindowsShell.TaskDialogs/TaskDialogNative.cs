...
namespace Sunburst.WindowsShell.TaskDialogs
{
    ...
    internal struct TASKDIALOGCONFIG
    {
        ...
        public IntPtr pszWindowTitle; // string
        public IntPtr hMainIcon;
        public IntPtr pszMainInstruction; // string
        public IntPtr pszContent; // string
        ...
        public IntPtr pszVerificationText; // string
        public IntPtr pszExpandedInformation; // string
        public IntPtr pszExpandedControlText; // string
        public IntPtr pszCollapsedControlText; // string
        public IntPtr hFooterIcon;
        public IntPtr pszFooter; // string
